            ...
            {sidebarOpen && (
              <>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 0.5, backdropFilter: "blur(6px)" }}
  ...
  return (
    <div className="p-6 flex flex-col h-full">
      ...
      <div className="flex justify-end mb-4">
        <button
          onClick={() => setSidebarOpen(false)}
          className="w-8 h-8 relative group focus:outline-none"
        >
          <span className="sr-only">Close</span>
          <span className="absolute block w-6 h-0.5 bg-white transform rotate-45 group-hover:rotate-90 transition duration-300 ease-in-out"></span>
          <span className="absolute block w-6 h-0.5 bg-white transform -rotate-45 group-hover:-rotate-90 transition duration-300 ease-in-out"></span>
        </button>
      </div>
