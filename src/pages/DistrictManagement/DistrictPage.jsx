...
export default function DistrictPage() {
  ...
  const filteredDistricts = districts.filter((emp) =>
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto space-y-6">
      <h1 className="text-md font-bold text-gray-800"> District Management</h1>

      {isAdding ? (
        <AddDistrictPage onClose={() => setIsAdding(false)} />
      ) : editData ? (
        <EditDistrictPage data={editData} onClose={() => setEditData(null)} />
      ) : (
        <>
          {/* Filter Header */}
<motion.div
