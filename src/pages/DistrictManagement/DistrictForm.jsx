...
export default function DistrictForm({ initialData = {}, onSubmit, onCancel, title }) {
  const defaultForm = {
    district: ""
  };
  ...
  const isRequired = (field) => ["district"].includes(field);
      ...
      <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-md text-xs relative">
        ...
        >
          ...
          <div className="space-y-1">
            <label className="text-xs text-gray-700 font-medium">District</label>
