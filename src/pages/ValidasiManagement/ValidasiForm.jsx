...
export default function StoreForm({ initialData = {}, onSubmit, onCancel, title }) {
 const defaultForm = {
  ...
  owner: "",
  telp: "",
  input_no_valid: "",     // misalnya: true/false atau catatan validasi
  reason_nomor: "",       // alasan kenapa nomor tidak valid
  respon: ""
};
...
{renderInput("frontliner", "Frontliner", UserCircle, { readOnly: true })}
{renderInput("outlet_id", "Outlet ID", Store)}
{renderInput("outlet_name", "Outlet Name", Store)}
{renderInput("address", "Address", MapPin)}
{renderInput("district", "District", MapPin)}
{renderInput("owner", "Owner", User)}
{renderInput("telp", "Telp", AlertTriangle)}
{renderInput("input_no_valid", "Input No Valid", Phone)}
{renderInput("reason_nomor", "Reason Nomor", Info)}
{renderInput("respon", "Respon", MessageCircle)}
