...
export default function EmployeePage() {
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto space-y-6">
      <h1 className="text-md font-bold text-gray-800"> Employee Management</h1>

      {isAdding ? (
        <AddEmployeePage onClose={() => setIsAdding(false)} />
      ) : editData ? (
        <EditEmployeePage data={editData} onClose={() => setEditData(null)} />
      ) : (
        <>
          {/* Filter Header */}
<motion.div
