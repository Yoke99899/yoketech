...
export default function ChannelPage() {
  ...
  const filteredChannels = channels.filter((emp) =>
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto space-y-6">
      <h1 className="text-md font-bold text-gray-800"> Channel Management</h1>

      {isAdding ? (
        <AddChannelPage onClose={() => setIsAdding(false)} />
      ) : editData ? (
        <EditChannelPage data={editData} onClose={() => setEditData(null)} />
      ) : (
        <>
          {/* Filter Header */}
<motion.div
