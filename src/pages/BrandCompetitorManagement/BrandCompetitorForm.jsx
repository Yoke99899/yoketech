...
export default function BrandCompetitorForm({ initialData = {}, onSubmit, onCancel, title }) {
  const defaultForm = {
    brandcompetitor: ""
  };
  ...
  const isRequired = (field) => ["brandcompetitor"].includes(field);
      ...
      <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-md text-xs relative">
        ...
        >
          ...
          <div className="space-y-1">
            <label className="text-xs text-gray-700 font-medium">Brand Competitor</label>
